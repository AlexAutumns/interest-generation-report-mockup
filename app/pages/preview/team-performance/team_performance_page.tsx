...
import { buildAgentRows, buildTeamStats } from "./team_performance_helpers";

import TeamPerformanceChartsRecharts from "./team_performance_charts_recharts";
import TeamPerformanceTable from "./team_performance_table";

function buildTeamPerformancePath(reportId: string) {
    return `/preview/team-performance?reportId=${encodeURIComponent(reportId)}`;
}
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex items-start justify-between gap-4">
                <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2">
                        <Users className="h-5 w-5 text-[#193E6B]" />
                        <h1 className="text-xl font-semibold text-[#193E6B]">
                            Team Performance
                        </h1>
                    </div>
                    <p className="text-sm text-gray-600">
                        Agent ranking and performance distribution for the
                        selected period.
                    </p>
            ...
            <motion.div
                ...
                whileHover={{ y: -2 }}
            >
                <TeamPerformanceChartsRecharts rows={rows} />
            </motion.div>
